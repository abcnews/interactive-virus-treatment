const animate = ks => { const tl = ks.animate("#All",[{p:'mpath',t:[0,1500],v:['0%','100%'],e:[[1,0,0,.6,1],[0]],mp:"M159.2,1728.1L715.8,856.2"},{p:'scaleX',t:[0,1500],v:[3,.6],e:[[1,0,0,.6,1],[0]]},{p:'scaleY',t:[0,1500],v:[3,.6],e:[[1,0,0,.6,1],[0]]}],
...
"#Tocilizumab",[{p:'opacity',t:[1000,1500],v:[1,0],e:[[0],[0]]}],
