const animate = ks => { const tl = ks.animate("#All",[{p:'mpath',t:[0,1000],v:['0%','100%'],e:[[1,0,0,.6,1],[0]],mp:"M82.6,1461.3L159.2,1728.2"}],
"#_a0",[{p:'rotate',t:[0,2000,4000],v:[-1205,-1565,-1925],e:[[0],[0],[0]]}],
"#_a1",[{p:'rotate',t:[0,2000],v:[-176.4,183.6],e:[[0],[0]]}],
...
"#_a8",[{p:'rotate',t:[0,2000],v:[-89,271],e:[[0],[0]]}],
